...
|-----------------------------------------------|-------------|----------|-----------|--------|--------|--------------------------------|
| bi-rerank `all-MiniLM-L6-v2`                  | 40 / 8      | 0.0198   | 0.0198    | 0.0198 | 0.0237 | Лучшее среди протестированных  |
| базовый embed (paraphrase-multilingual)       | 50 / 5-10   | 0.0099   | 0.0198    | 0.0142 | 0.0088 | Без доп. реранка               |
